# Corte rapido, fora do trabalho normal

**Isto e avulso — nao faz parte do trabalho normal da skill.** Use so quando a pessoa pedir exatamente
isto, e nada mais: so acelerar, ou so tirar os silencios, sem montar o video, sem legenda, sem
escolher estilo.

**O trabalho normal nao usa estes comandos.** Dentro delas, o motor corta o silencio olhando a
...
antes do trabalho normal atrapalha**: tira a margem que o motor precisa para achar onde a fala comeca
...
trabalho normal, usa o outro metodo, o de cima: ele olha a energia da fala inteira, nao um limite fixo
de volume.
